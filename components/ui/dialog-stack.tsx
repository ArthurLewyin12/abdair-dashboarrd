...
// Hook pour utiliser le contexte DialogStack
...
export const DialogStack = ({
  ...
  // Sync the controlled prop with internal state
  useEffect(() => {
    setIsOpen(open);
...
export const DialogStackBody = ({
  ...
  // Mettre à jour totalDialogs quand children change
  useEffect(() => {
    const newTotal = Children.count(children);
    setTotalDialogs(newTotal);
  }, [children]);
